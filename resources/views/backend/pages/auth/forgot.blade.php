...
@section('pageTitle', isset($pageTitle) ? $pageTitle : 'Forgot Password | CRM Laravel Tabler UI Kit')
@section('content')
  ...
  <div class="container container-tight py-4">
    <div class="text-center mb-4">
      <a href="." class="navbar-brand navbar-brand-autodark">
        <h1 class="text-primary font-black text-uppercase">CRM Laravel Tabler UI Kit</h1>
